...
class _SquareScreenState extends State<SquareScreen> {
  ...
  List<String> _list = ["Square from 0 to 100","Square from 101 to 200","Square from 201 to 300","Square from 301 to 400","Square from 401 to 500","Square from 501 to 600","Square from 601 to 700","Square from 701 to 800","Square from 801 to 900","Square from 901 to 1000"];
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap:() {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context) => SquareLogicScreen(value:(index+1))));
                  },
                  child: Padding(
